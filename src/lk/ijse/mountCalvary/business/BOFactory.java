...
public class BOFactory {
    ...
    public enum BOType{
        STUDENT, LOG_IN, ACTIVITY, TEL_NO, TEACHER, REGISTRATION, EVENT, ATTENDANT_SHEET, COMPETITION, AGE_GROUP, EVENT_LIST, PARTICIPATION, PAYMENT, TEACHER_IN_CHARGE_LIST
    }
