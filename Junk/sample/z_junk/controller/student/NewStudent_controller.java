...
public class NewStudent_controller implements Initializable {
    ...
    @FXML
    private JFXButton btNext_NewStudent;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Main_NewStudent.getInstance().setNewStudent(this);
    }
    @FXML
    ...
    @FXML
    void txtStudentID(ActionEvent event) {
    ...
    @FXML
    private void btNext_NewStudent_onAction(ActionEvent actionEvent) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/student/MorePersonalDetail.fxml", this.acNewStudent, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
