...
public class ActivityMenu_controller implements Initializable {
    ...
    void btBack_onAction(ActionEvent event) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/basic/MainMenu.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void btUpdateActivity_onAction(ActionEvent event) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/activity/UpdateActivity.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void btAddStudent_onAction(ActionEvent actionEvent) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/activity/AddStudentForActivity.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void btNewEvent_onAction(ActionEvent actionEvent) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/activity/NewEventForActivity.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void btNewActivity_onAction(ActionEvent actionEvent) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/activity/NewActivity.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void btActivityProfile_onAction(ActionEvent actionEvent) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/activity/profile/ActivityProfile.fxml", acActivityMenu, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
