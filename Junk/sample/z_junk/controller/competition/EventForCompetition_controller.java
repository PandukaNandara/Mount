...
public class EventForCompetition_controller implements Initializable {
    ...
    void btBack_EventForActivity_onAction(ActionEvent event) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/competition/NewCompetition.fxml", this.acEventForCompetition, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void btNext_EventForActivity_onAction(ActionEvent event) {
        try {
            ScreenLoader.loadPanel("/sample/z_junk/view/competition/StudentForCompetition.fxml", this.acEventForCompetition, this);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
